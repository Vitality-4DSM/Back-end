...
async function sincronizar() {
  ...
  for (let i = 0; i < lista.length; i++) {
    ...
    const response = await fetch('http://40.76.110.239:3001/station/', { headers: { 'x-api-key': '4554545sdsdsd5454' } });
    ...
    const responseTipoDeParametros = await fetch('http://40.76.110.239:3001/typeparameter/', { headers: { 'x-api-key': '4554545sdsdsd5454' } });
    ...
    const responseParametros = await fetch('http://40.76.110.239:3001/parameter/', { headers: { 'x-api-key': '4554545sdsdsd5454' } });
  ...
  const responseAlerta = await fetch('http://40.76.110.239:3001/alert/', { headers: { 'x-api-key': '4554545sdsdsd5454' } });
            ...
            if (tipo === "==") {
              if (valor.valor == alerta.valor) {
                ...
                valores.forEach(valorObj => {
                  fetch('http://40.76.110.239:3001/valor/', {
                ...
                alertasEncontrados.forEach(valorObj => {
                  fetch('http://40.76.110.239:3001/valor/', {
                    ...
                    fetch('http://40.76.110.239:3001/historicalert/', {
                      method: 'POST', headers: { 'Content-Type': 'application/json', 'x-api-key': '4554545sdsdsd5454' },
